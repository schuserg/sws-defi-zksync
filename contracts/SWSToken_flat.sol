...
// File contracts/SWSToken.sol

// Original license: SPDX_License_Identifier: MIT
pragma solidity ^0.8.20;


/// @title SWSToken - Main staking token for the zkSync DeFi protocol
/// @notice This token can be minted and burned, controlled by the contract owner
contract SWSToken is ERC20, Ownable {
    event Minted(address indexed to, uint256 amount);
    event Burned(address indexed from, uint256 amount);

    constructor() ERC20("SWS Token", "SWST") Ownable(msg.sender) {}

    /// @notice Mint new tokens (only the owner)
