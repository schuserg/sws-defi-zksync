...
// File contracts/DOLToken.sol

// Original license: SPDX_License_Identifier: MIT
pragma solidity ^0.8.20;


/// @title DOLToken — ERC20 reward token for staking
/// @notice Only staking contract (owner) can mint rewards
contract DOLToken is ERC20, Ownable {
    event Minted(address indexed to, uint256 amount);
    event Burned(address indexed from, uint256 amount);

    constructor() ERC20("DOL Token", "DOL") Ownable(msg.sender) {}

    /// @notice Mint new tokens (only owner — staking contract)
